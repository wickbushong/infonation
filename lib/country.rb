...
class Country
    ...
    attr_accessor :name, :capital, :currencies, :population, :languages, :alpha3code, :area, :region, :sub_region, :borders, :lat, :lng, :alt_spellings, :demonym, :gini_index, :timezones, :native_name, :flag, :domain
    @@all = []
